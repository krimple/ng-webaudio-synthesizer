...
var NoteTranslationService = (function () {
    function NoteTranslationService() {
        ...
        this.defaultOctaves = [3, 4];
    }
    NoteTranslationService.prototype.getDefaultScaleFrequencies = function (octaves) {
        if (octaves === void 0) { octaves = this.defaultOctaves; }
        return this.getScaleFrequencies(Object.keys(this.scales)[0], octaves);
    };
    NoteTranslationService.prototype.getFrequency = function (note) {
        return this.noteMappings[note];
    };
    NoteTranslationService.prototype.getScaleFrequencies = function (scale, octaves) {
        var _this = this;
        if (octaves === void 0) { octaves = this.defaultOctaves; }
        var freqs = [];
        octaves.forEach(function (curOctave) {
            freqs = freqs.concat(_this.scales[scale].map(function (curNote) {
                return _this.noteMappings[curNote + curOctave];
            }));
        });
        return freqs;
    };
