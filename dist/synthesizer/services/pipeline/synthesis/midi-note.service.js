...
var Note = (function () {
    ...
    Note.configure = function (context, audioBus) {
        Note.context = context;
        Note.audioBus = audioBus;
        // Note.controlPanelDataChanges$ = controlPanelDataChanges$;
    };
    Note.changeWaveform = function (waveform) {
        Note.waveform = waveform.waveForm;
    };
    Note.prototype.getNewOscillator = function () {
...
var ToneWorker = (function () {
    function ToneWorker(oscillator, frequency, currentTime, outputBus, stopWatcher$) {
        ...
        oscillator.start(0);
        var subscription = stopWatcher$.subscribe(function (cutoffTime) {
...
var ControlPanelData = (function () {
    function ControlPanelData() {
