...
var MidiNoteService = (function () {
    function MidiNoteService(audioContext) {
        this.audioContext = audioContext;
    }
    MidiNoteService.prototype.setup = function (synthStream$, audioBus) {
        Note.configure(this.audioContext, synthStream$, audioBus);
        this.notes = [
            new Note(['C0'], 16.3516),
...
var Note = (function () {
    function Note(noteValues, frequency) {
        ...
        this.subscriptions.push(Note.synthStream$
            .filter(function (message) { return message instanceof synth_note_message_1.VolumeChange; })
    ...
    Note.prototype.noteOn = function () {
        ...
        setTimeout(function () {
            ...
            new ToneWorker(Note.context, _this.frequency, _this.waveform, now, _this.volume, _this.attack, _this.sustain, _this.decay, Note.audioBus, _this.stopWatcher$);
